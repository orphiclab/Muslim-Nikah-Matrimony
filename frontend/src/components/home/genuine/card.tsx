...
const DecorativeBorder = ({ accentColor = '#DB9D30' }: { accentColor?: string }) => (
    <svg
        width="202"
        height="199"
        viewBox="0 0 202 199"
    ...
    >
        ...
        <use href="#decor-border-shape" fill={accentColor} />
        <use
...
const GenuineProfileCard = ({
    ...
    const borderAccentColor = gender?.toUpperCase() === 'FEMALE' ? '#DF7285' : '#DB9D30';
            ...
            <div className="px-4 pt-2">
                ...
                <div className="relative w-[90px] h-[90px] sm:w-[110px] sm:h-[110px] lg:w-[120px] lg:h-[120px] xl:w-[130px] xl:h-[130px] 2xl:w-[140px] 2xl:h-[140px] mx-auto mt-1 mb-3">
                    <div className="absolute inset-0 w-full h-full">
                        <DecorativeBorder accentColor={borderAccentColor} />
                    </div>
